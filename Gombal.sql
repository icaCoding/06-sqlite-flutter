...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Mar 2022 pada 06.11
...
(5, '2021_12_12_033359_create_table_customer', 1),
(6, '2021_12_12_033549_create_table_barang', 1),
(7, '2021_12_12_033626_create_table_transaksi', 1);
...
CREATE TABLE `table_transaksi` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kode_sewa` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_customer` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_barang` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tgl_pinjam` date NOT NULL,
  `status` enum('Dikembalikan','Pengembalian') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `no hp` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role` enum('admin','tambalban','pelanggan') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pelanggan',
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `alamat`, `no hp`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Tester', 'tester@gmail.com', NULL, '$2y$10$7qrjREQJhz41m18c8.rKvuIbPG4.rqY.0FD1NzYU5gNLMDIQMFgEi', NULL, NULL, 'pelanggan', NULL, '2022-03-30 20:17:38', '2022-03-30 20:17:38');
